...
CRdraw_polygon <- function(graphics_list, polygon_list) {
  ...
  invisible( .Call("SDLdraw_polygon", graphics_list, polygon_list$x, polygon_list$y, length(polygon_list$x), PACKAGE = "CREx") )
}
