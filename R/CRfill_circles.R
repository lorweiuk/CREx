...
CRfill_circles <- function(graphics_list, circle_list) {
  ...
  invisible( .Call("SDLfill_circles", graphics_list, circle_list$centerx, circle_list$centery, circle_list$radius, length(circle_list$centerx), PACKAGE = "SDLDLL") )
